...
class _OverviewState extends State<Overview> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        toolbarHeight: 75,
        leading: widget.t != null ? TextButton.icon(icon: Icon(Icons.arrow_back_ios, size: 30, color: Colors.black54,), onPressed: (){
                  ...
                  if(i == widget.topics.length ){
                    return TextButton(onPressed: ()async{
                      ...
                      if(await getNewTopics(widget.topics.last)){
                        ...
                        child: Text(loadingMoreString, style: TextStyle(color: Colors.black54),));
                  }
